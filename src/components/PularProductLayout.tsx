...
interface PularProductLayoutProps {
    title: string;
    description: string;
    btu: string;
    price: string;
...
export default function PularProductLayout({
    title,
    description,
    btu,
    price,
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="flex flex-col">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <span className="text-sm font-bold text-gray-500">Kompakt ve Fonksiyonel Konfor</span>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-3 mb-8">
                                ...
                                <div className="flex items-center gap-2 px-4 py-2 bg-green-50/50 text-green-700 rounded-full text-[11px] font-bold border border-green-100/50 tracking-wider">
                                    <Wind className="w-4 h-4" /> MAT BEYAZ TASARIM
                                </div>
                    ...
                    <div className="flex flex-col gap-12">
                        ...
                        <div className="w-full">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
                                {[
                                    { label: "Ürün Kataloğu", icon: "/aphro/pdf-icon.webp", link: "/pular/Gree-Pular-Duvar-Tipi-Inverter-Klima.pdf" },
                                    { label: "Kullanım Kılavuzu", icon: "/aphro/kilavuz-icon.png", link: "/pular/Pular-Split-Klima-Kullanici-Kilavuzu_TR-1.pdf" },
                                    { label: "Ürün Etiketi", icon: "/aphro/etiket-icon.webp", link: "/pular/Gree-Pular-Enerji-Etiketi.pdf" },
