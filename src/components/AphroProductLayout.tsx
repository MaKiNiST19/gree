...
interface AphroProductLayoutProps {
    title: string;
    description: string;
    btu: string;
    price: string;
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                ...
                                >
                                    ...
                                    <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100 z-10">
                                        <div className="bg-white/95 p-5 rounded-full shadow-2xl transform scale-90 group-hover:scale-100 transition-transform">
                                            {/* Magnify icon using Search from Lucide */}
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                {galleryImages.map((img, i) => (
                                    <div 
                                        ...
                                        className={`bg-white p-2 rounded-2xl border transition-all cursor-pointer overflow-hidden h-20 flex items-center justify-center ${activeImageIndex === i ? 'border-blue-500 ring-4 ring-blue-500/10' : 'border-gray-100 hover:border-blue-300'}`}
                                    >
                        ...
                        <div className="flex flex-col">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <span className="text-sm font-bold text-gray-500">Mükemmel Konfor Özellikleri</span>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-3 mb-8">
                                <div className="flex items-center gap-2 px-4 py-2 bg-blue-50/50 text-blue-700 rounded-full text-[11px] font-bold border border-blue-100/50 tracking-wider">
                                    <Smartphone className="w-4 h-4" /> AKILLI KONTROL
                                </div>
                                <div className="flex items-center gap-2 px-4 py-2 bg-green-50/50 text-green-700 rounded-full text-[11px] font-bold border border-green-100/50 tracking-wider">
                                    <Wind className="w-4 h-4" /> ULTRA SESSİZ
                                </div>
                                <div className="flex items-center gap-2 px-4 py-2 bg-orange-50/50 text-orange-700 rounded-full text-[11px] font-bold border border-orange-100/50 tracking-wider">
                                    <Shield className="w-4 h-4" /> GELİŞMİŞ FİLTRE
                                </div>
                            </div>
                            <p className="text-lg text-gray-500 mb-8 font-medium leading-relaxed max-w-xl">
                                G10 Inverter teknolojisi ile maksimum enerji tasarrufu ve üstün performans. 
                                Aphro serisinin şık tasarımı ve sessiz çalışma özelliğiyle yaşam alanlarınızda konforu keşfedin.
                            </p>
                    ...
                    <div className="flex flex-col gap-12">
                        ...
                        <div className="w-full">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
                                {[
                                    { label: "Ürün Kataloğu", icon: "/aphro/pdf-icon.webp", link: "/aphro/Gree-Aphro-Duvar-Tipi-Inverter-Klima.pdf" },
                                    { label: "Kullanım Kılavuzu", icon: "/aphro/kilavuz-icon.png", link: "/aphro/Gree-Aphro-Kullanim-Kilavuzu_TR_-Duzenleme-Garanti-Belgeli.pdf" },
                                    { label: "Ürün Etiketi", icon: "/aphro/etiket-icon.webp", link: "/aphro/aphro-etiket.png" },
