...
export default function MultiProductLayout({
    title,
    description,
    btu,
    price = "",
    ...
    documents = [
        ...
        { label: "Ürün Etiketi", icon: "/aphro/etiket-icon.webp", link: "/multi/multi18.png" }
    ]
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="flex flex-col">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <span className="text-sm font-bold text-gray-500">Profesyonel Multi Sistem</span>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-3 mb-8">
                                <div className="flex items-center gap-2 px-4 py-2 bg-blue-50/50 text-blue-700 rounded-full text-[11px] font-bold border border-blue-100/50 tracking-wider">
                                    <Gauge className="w-4 h-4" /> {btu} BTU KAPASİTE
                                </div>
                                <div className="flex items-center gap-2 px-4 py-2 bg-green-50/50 text-green-700 rounded-full text-[11px] font-bold border border-green-100/50 tracking-wider">
                                    <Wind className="w-4 h-4" /> YÜKSEK VERİMLİLİK
                                </div>
                                <div className="flex items-center gap-2 px-4 py-2 bg-orange-50/50 text-orange-700 rounded-full text-[11px] font-bold border border-orange-100/50 tracking-wider">
                                    <Shield className="w-4 h-4" /> PROFESYONEL MONTAJ
                                </div>
                            </div>
