...
export const Wreath = (props: HTMLAttributes<HTMLOrSVGElement>) => (
    <svg width="36" height="81" viewBox="0 0 36 81" fill="none" {...props} className={`text-[#f39000] ${props.className || ''}`}>
        <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <div {...props} className={`flex items-center space-x-1 ${className}`}>
            ...
            <div className="flex flex-col items-center justify-center min-w-[150px]">
                <div className="text-center">
                    <p className="text-sm md:text-base font-bold text-gray-800">{title}</p>
                    <p className="text-xs md:text-sm font-medium text-gray-500">{subtitle}</p>
                </div>
            </div>

            <Wreath className="shrink-0 w-8 md:w-10 opacity-70 -scale-x-100" />
        </div>
    );
};
