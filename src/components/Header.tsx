...
export default function Header() {
    ...
    return (
        <>
            ...
            <div className="absolute lg:fixed top-3 md:top-5 w-full left-0 z-50 px-12 flex justify-center pointer-events-none">
                <header className="relative bg-white/95 backdrop-blur-sm rounded-lg md:rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] pointer-events-auto w-full px-6 lg:px-10 border border-gray-100">
                    <div className="flex justify-between items-center h-[72px]">
                        <div className="flex-1 flex justify-start items-center space-x-4">
                            <Link href="/" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="flex items-center">
                                <img src="/deytes-iklimlendirme-logo.png" alt="Deytes İklimlendirme Logo" className="h-10 md:h-12 w-auto object-contain" />
                            </Link>
                            <div className="h-6 w-[1.5px] bg-gray-200 ml-4 mr-0" />
                            <Link href="/" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="flex items-center pl-4">
                                <img src="/gree-klima-logo.png" alt="Gree Klima Logo" className="h-6 md:h-8 w-auto object-contain" />
                            </Link>
                        </div>
                        ...
                        <div className="flex-1 flex justify-end items-center space-x-6">
                            ...
                            <Link href="tel:+902322316583" className="fancy-button bg-[#009be1] text-white font-medium text-[15px] py-2.5 px-6 rounded-md shadow-sm border border-transparent">
                                Bizi Arayın
                            </Link>

                            {/* Mobile menu trigger could be added here if needed, but the request focuses on link behavior */}
                        </div>
                    </div>
                </header>
            </div>
            ...
            <div className="w-full h-[84px] md:h-[92px]"></div>
        </>
    );
}
