...
const WhatsAppButton = () => {
  return (
    <a 
      href="https://wa.me/902322316583"
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-[999] group pointer-events-auto"
      aria-label="Chat on WhatsApp"
    >
      <button className="relative bg-green-500 text-white w-14 h-14 rounded-full flex justify-center items-center shadow-lg hover:bg-green-600 transition-all duration-300 ease-out group hover:scale-105 active:scale-95" aria-label="Chat on WhatsApp">
