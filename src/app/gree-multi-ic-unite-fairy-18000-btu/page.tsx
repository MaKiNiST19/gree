...
const galleryImages = [
    "/img/products/multi-sistem/multi-duvar-tipi-fairy-ic-unite-12000-btu-h-0.png",
    "/img/products/multi-sistem/multi-duvar-tipi-fairy-ic-unite-12000-btu-h-1.png"
];
