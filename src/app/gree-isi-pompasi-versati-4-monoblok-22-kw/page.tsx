...
export const metadata = generateSEO({
    title: 'Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 22 kW | İzmir Yetkili Bayi',
    description: 'GRS-CQ22PD/NHG3-E stok kodlu Gree Versati IV Monoblok Tip Isı Pompası serisi ısı pompası. 22 kW kapasite, yüksek enerji tasarrufu ve çevreci R32 gaz.',
    pathname: '/gree-isi-pompasi-versati-4-monoblok-22-kw',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GRS-CQ22PD/NHG3-E" },
    { label: "Kapasite", value: "22 kW" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 22 kW', url: '/gree-isi-pompasi-versati-4-monoblok-22-kw' }
    ]);

    return (
        <MultiProductLayout
            title="Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 22 kW"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 22 kW İle Ekonomik İklimlendirme</h3>
            ...
            galleryImages={["/img/products/isi-pompasi/versati-4-monoblok-60-c-r32-wifi-23-kw-0.png", "/img/products/isi-pompasi/versati-4-monoblok-60-c-r32-wifi-23-kw-1.png"]}
            documents={[
