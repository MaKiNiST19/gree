...
const galleryImages = [
    "/img/products/multi-sistem/multi-duvar-tipi-amber-ic-unite-24000-btu-h-0.jpg",
    "/img/products/multi-sistem/multi-duvar-tipi-amber-ic-unite-24000-btu-h-1.jpg"
];
