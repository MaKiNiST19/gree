...
export const metadata = generateSEO({
    title: 'Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 12 kW (Elektrikli Isıtıcılı) | İzmir Yetkili Bayi',
    description: 'GRS-CQ12PD/NHG3-E stok kodlu Gree Versati IV Monoblok Tip Isı Pompası serisi ısı pompası. 12 kW kapasite, yüksek enerji tasarrufu ve çevreci R32 gaz.',
    pathname: '/gree-isi-pompasi-versati-4-monoblok-12-kw-heat',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GRS-CQ12PD/NHG3-E" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 12 kW (Elektrikli Isıtıcılı)', url: '/gree-isi-pompasi-versati-4-monoblok-12-kw-heat' }
    ]);

    return (
        <MultiProductLayout
            title="Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 12 kW (Elektrikli Isıtıcılı)"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 12 kW (Elektrikli Isıtıcılı) İle Ekonomik İklimlendirme</h3>
