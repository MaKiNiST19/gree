            ...
            <article className="py-20 bg-white px-4">
                <div className="max-w-4xl mx-auto prose prose-lg lg:prose-xl text-gray-700">
                    ...
                    <ul>
                        ...
                        <li><strong>Dışarıdan Yırtıcı Traktör Fan Sesi Geliyor Mu?:</strong> Eğer takozları bozulmuş dış ünite sarsılarak bağırıp odaya titreşim kusuyor ve hiç rüzgar vurup duraklıyorsa, cihaz kompresörü ateş almış (<Link href="/iletisim" className="font-bold underline text-blue-800">İletişim Kurun</Link>). Fan motoru kısa devrededir.</li>
                    </ul>
