...
export const metadata = generateSEO({
    title: 'Gree Fairy 12000 BTU/h Beyaz Inverter Klima | İzmir Gree Klima',
    description: 'En uygun Gree Fairy 12000 BTU/h Beyaz Inverter Klima fiyatı (43.500,00 TL). Beyaz tasarım, R32 gaz, Wi-Fi kontrolü ve 6 yıl garanti ile İzmir yetkili bayisinde.',
    pathname: '/gree-fairy-12000-btu-beyaz-duvar-tipi-klima',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GWH12ACC-K6DNA1F-W" },
...
export default function Page() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'Fairy 12000 BTU/h - Beyaz', url: '/gree-fairy-12000-btu-beyaz-duvar-tipi-klima' }
    ]);

    return (
        <FairyProductLayout
            title="Gree Fairy 12000 BTU/h Beyaz Inverter Klima"
            ...
            btu="12000"
            price="43.500,00 TL"
            installment="4.060,00 TL'den başlayan taksitler"
            techSpecs={techSpecs}
            colorLabel="BEYAZ TASARIM"
            seoContent={<FairyDynamicSeoArticle modelCode="GWH12ACC-K6DNA1F-W" btu="12000" price="43.500,00 TL" installment="4.060,00 TL'den başlayan taksitler" color="Beyaz" />}
