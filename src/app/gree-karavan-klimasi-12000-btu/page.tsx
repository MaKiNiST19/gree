...
export const metadata = generateSEO({
    title: 'Gree Karavan Kliması - 12.000 BTU/h | İzmir Yetkili Bayi',
    description: 'GRH120DB-K6NA1A stok kodlu Gree Karavan Kliması serisi ticari klima. 12.000 BTU/h kapasite, Inverter teknolojisi ve yüksek enerji verimliliği.',
    pathname: '/gree-karavan-klimasi-12000-btu',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GRH120DB-K6NA1A" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'Karavan Kliması - 12.000 BTU/h', url: '/gree-karavan-klimasi-12000-btu' }
    ]);

    return (
        <MultiProductLayout
            title="Gree Karavan Kliması - 12.000 BTU/h"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree Karavan Kliması - 12.000 BTU/h İle Profesyonel Çözümler</h3>
