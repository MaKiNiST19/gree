...
export const metadata = generateSEO({
    title: 'Gree Yer/Tavan Tip Inverter Klima - 42000 BTU/h | İzmir Yetkili Bayi',
    description: 'GUD125ZD1/A-S stok kodlu Gree Yer Tavan Tipi Ticari Klima serisi ticari klima. 42.000 BTU/h kapasite, Inverter teknolojisi ve yüksek enerji verimliliği.',
    pathname: '/gree-ticari-klima-yer-tavan-tipi-42000-btu',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GUD125ZD1/A-S" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'Yer/Tavan Tip Inverter Klima - 42000 BTU/h', url: '/gree-ticari-klima-yer-tavan-tipi-42000-btu' }
    ]);

    return (
        <MultiProductLayout
            title="Gree Yer/Tavan Tip Inverter Klima - 42000 BTU/h"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree Yer/Tavan Tip Inverter Klima - 42000 BTU/h İle Profesyonel Çözümler</h3>
