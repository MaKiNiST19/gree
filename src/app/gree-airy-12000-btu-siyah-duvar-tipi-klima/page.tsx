...
export const metadata = generateSEO({
    title: 'Gree Airy 12000 BTU/h Siyah Inverter Klima | İzmir Gree Klima',
    description: 'En uygun Gree Airy 12000 BTU/h Siyah Inverter Klima fiyatı (58.400,00 TL). Siyah tasarım, G10 Inverter, R32 gaz ve Wi-Fi kontrolü ile İzmir yetkili bayisinde.',
    pathname: '/gree-airy-12000-btu-siyah-duvar-tipi-klima',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GWH12AVCXB-K6DNA1B-B" },
    { label: "Kapasite", value: "12000 BTU/h" },
    { label: "Isıtma Kapasitesi (Min.~ Nominal~Maks.) BTU/h", value: "3.412~12.966~17.060" },
...
export default function Page() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'Airy 12000 BTU/h - Siyah', url: '/gree-airy-12000-btu-siyah-duvar-tipi-klima' }
    ]);

    return (
        <AiryProductLayout
            title="Gree Airy 12000 BTU/h Siyah Inverter Klima"
            ...
            btu="12000"
            price="58.400,00 TL"
            installment="5.450,67 TL'den başlayan taksitler"
            techSpecs={techSpecs}
            colorLabel="SİYAH TASARIM"
            seoContent={<AiryDynamicSeoArticle modelCode="GWH12AVCXB-K6DNA1B-B" btu="12000" price="58.400,00 TL" installment="5.450,67 TL'den başlayan taksitler" color="Siyah" />}
