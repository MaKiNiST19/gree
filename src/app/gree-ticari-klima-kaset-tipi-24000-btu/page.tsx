...
export const metadata = generateSEO({
    title: 'Gree Kaset Tipi Inverter Klima - 24000 BTU/h | İzmir Yetkili Bayi',
    description: 'GUD71T1/A-S stok kodlu Gree Kaset Tipi Ticari Klima serisi ticari klima. 24.000 BTU/h kapasite, Inverter teknolojisi ve yüksek enerji verimliliği.',
    pathname: '/gree-ticari-klima-kaset-tipi-24000-btu',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GUD71T1/A-S" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'Kaset Tipi Inverter Klima - 24000 BTU/h', url: '/gree-ticari-klima-kaset-tipi-24000-btu' }
    ]);

    return (
        <MultiProductLayout
            title="Gree Kaset Tipi Inverter Klima - 24000 BTU/h"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree Kaset Tipi Inverter Klima - 24000 BTU/h İle Profesyonel Çözümler</h3>
