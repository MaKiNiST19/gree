...
export const metadata = generateSEO({
    title: 'Gree Multi Sistem Kaset Tek Yön İç Ünite 9000 BTU/h | İzmir Yetkili Bayi',
    description: 'GKH9DA-K6DNA1A/I stok kodlu Gree Kaset Tek Yön serisi multi sistem iç ünite. Estetik tasarım, sessiz çalışma ve yüksek konfor. İzmir Gree yetkili servis güvencesiyle.',
    pathname: '/gree-multi-ic-unite-kaset-tek-yon-9000-btu',
});

const techSpecs = [
    {
        "label": "Stok Kodu",
        "value": "GKH9DA-K6DNA1A/I"
    },
    {
        "label": "Kapasite",
        "value": "9.000 BTU/h"
...
export default function Page() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'Kaset Tek Yön 9000 BTU/h İç Ünite', url: '/gree-multi-ic-unite-kaset-tek-yon-9000-btu' }
    ]);

    return (
        <MultiProductLayout
            title="Gree Multi Sistem Kaset Tek Yön İç Ünite 9000 BTU/h"
            ...
            btu="9000"
            techSpecs={techSpecs}
            seoContent={<MultiDynamicSeoArticle modelCode="GKH9DA-K6DNA1A/I" btu="9000" />}
