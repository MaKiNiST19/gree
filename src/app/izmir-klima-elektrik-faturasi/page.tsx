                ...
                <div className="max-w-4xl mx-auto prose prose-lg lg:prose-xl text-gray-700">
                    ...
                    <div className="bg-orange-50 border-l-4 border-orange-500 p-8 my-8 rounded-lg shadow-sm">
                        ...
                        <p className="text-gray-700 m-0">
                            Senaryomuz İzmir Bornova ilçesinde orta kat bir binada 30 m² L tipi bir odada geçsin. Kullanıcımız <Link href="/izmir-gree-klima-satis">Gree Fairy Inverter 18.000 BTU</Link> klimasını almış olsun ve çok sıcaklarda günde 10 saat durmaksızın (24 derece hedefine sabitleyerek) açık tutsun. Gree Fairy, cihaz 24 dereceye erişince odayı o soğuklukta hissettirmeden tutabilmek için kompresör tüketimini 300 Watt'ın bile altına gömebildiğinden (buna Rölanti denir); günde yaklaşık sadece 3.5 kWh yakar. Ay sonu klimanın haneye attığı toplam yük kaba hesapça ~105 kWh faturadır. Eğer eski cihaz olsaydı en az ~300 kWh yollayacaktı! Ev zaten düşük kademe içindeyken yavaş yavaş tepeyi zorlar ancak o kaba 105 kW ekleme ile fatura sadece şaşılacak derecede fırlamadan, bir aylık mutfak alışverişinin onda birine dahi denk gelmeyerek buzu evinize mühürler.
                        </p>
                    </div>
