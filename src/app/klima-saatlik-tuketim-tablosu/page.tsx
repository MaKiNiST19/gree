                ...
                <div className="max-w-5xl mx-auto prose prose-lg lg:prose-xl text-gray-700">
                    ...
                    <div className="bg-orange-50 border-l-4 border-orange-500 p-8 my-8 rounded-lg shadow-sm">
                        ...
                        <p className="text-gray-700 m-0">
                            Senaryomuz İzmir Bayraklı'da direkt olarak öğle sıcağında güneş yiyen bir plaza veya apartman dairesi olsun. Ortalama yalıtımlı bu 35 metrekarelik dev alana konulan <Link href="/gree-klima-satis-izmir">Gree 18.000 BTU Inverter A+++ özellikli</Link> cihazımız yaz aylarında kullanıcısı tarafından kumandada 24 dereceye sabitlensin. İlk açılışta oda o kadar genişken içindeki "Isı yutumu" nedeniyle cihaz yaklaşık 1 Saat boyunca o Max/Tam yüküne (Saatte 1.6 kW) yaslanacaktır. Bir saatin ardından o kocaman mekan buz gibi olunca cihaz kendini <Link href="/blog/inverter-on-off-klima-farklari">inverter teknolojisi eşliğinde</Link> rölantiye salar. Sonraki 9 saatte sadece saatlik (0.45 kW ortalama) çeker. <br /><br />
