...
export const metadata = generateSEO({
    title: 'Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 10 kW | İzmir Yetkili Bayi',
    description: 'GRS-CQ10PD/NHG4-E stok kodlu Gree Versati IV Monoblok Tip Isı Pompası serisi ısı pompası. 10 kW kapasite, yüksek enerji tasarrufu ve çevreci R32 gaz.',
    pathname: '/gree-isi-pompasi-versati-4-monoblok-10-kw',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GRS-CQ10PD/NHG4-E" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 10 kW', url: '/gree-isi-pompasi-versati-4-monoblok-10-kw' }
    ]);

    return (
        <MultiProductLayout
            title="Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 10 kW"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 10 kW İle Ekonomik İklimlendirme</h3>
