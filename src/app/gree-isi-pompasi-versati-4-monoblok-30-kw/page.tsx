...
export const metadata = generateSEO({
    title: 'Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 30 kW | İzmir Yetkili Bayi',
    description: 'GRS-CQ30PD/NHG3-E stok kodlu Gree Versati IV Monoblok Tip Isı Pompası serisi ısı pompası. 30 kW kapasite, yüksek enerji tasarrufu ve çevreci R32 gaz.',
    pathname: '/gree-isi-pompasi-versati-4-monoblok-30-kw',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GRS-CQ30PD/NHG3-E" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 30 kW', url: '/gree-isi-pompasi-versati-4-monoblok-30-kw' }
    ]);

    return (
        <MultiProductLayout
            title="Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 30 kW"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 30 kW İle Ekonomik İklimlendirme</h3>
            ...
            galleryImages={["/img/products/isi-pompasi/versati-4-monoblok-60-c-r32-wifi-30-kw-0.png", "/img/products/isi-pompasi/versati-4-monoblok-60-c-r32-wifi-30-kw-1.png"]}
            documents={[
