...
export const metadata = generateSEO({
    title: 'Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 8 kW (Elektrikli Isıtıcılı) | İzmir Yetkili Bayi',
    description: 'GRS-CQ8.0PD/NHG3-E1 stok kodlu Gree Versati IV Monoblok Tip Isı Pompası serisi ısı pompası. 8 kW kapasite, yüksek enerji tasarrufu ve çevreci R32 gaz.',
    pathname: '/gree-isi-pompasi-versati-4-monoblok-8-kw-heat',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GRS-CQ8.0PD/NHG3-E1" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 8 kW (Elektrikli Isıtıcılı)', url: '/gree-isi-pompasi-versati-4-monoblok-8-kw-heat' }
    ]);

    return (
        <MultiProductLayout
            title="Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 8 kW (Elektrikli Isıtıcılı)"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 8 kW (Elektrikli Isıtıcılı) İle Ekonomik İklimlendirme</h3>
            ...
            galleryImages={["/img/products/isi-pompasi/versati-4-monoblok-60-c-r32-wifi-8-kw-0.png", "/img/products/isi-pompasi/versati-4-monoblok-60-c-r32-wifi-8-kw-1.png"]}
            documents={[
