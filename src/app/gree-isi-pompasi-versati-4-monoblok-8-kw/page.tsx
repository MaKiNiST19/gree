...
export const metadata = generateSEO({
    title: 'Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 8 kW | İzmir Yetkili Bayi',
    description: 'GRS-CQ8.0PD/NHG4-E1 stok kodlu Gree Versati IV Monoblok Tip Isı Pompası serisi ısı pompası. 8 kW kapasite, yüksek enerji tasarrufu ve çevreci R32 gaz.',
    pathname: '/gree-isi-pompasi-versati-4-monoblok-8-kw',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GRS-CQ8.0PD/NHG4-E1" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 8 kW', url: '/gree-isi-pompasi-versati-4-monoblok-8-kw' }
    ]);

    return (
        <MultiProductLayout
            title="Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 8 kW"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 8 kW İle Ekonomik İklimlendirme</h3>
