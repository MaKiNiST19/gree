...
export const metadata = generateSEO({
    title: 'Gree Kaset Tipi Ticari Klima | İzmir Ticari İklimlendirme',
    description: '360 derece hava üfleme özelliğiyle ofis ve mağazalarda homojen iklimlendirme sağlayan kaset tipi çözümler.',
    pathname: '/gree-ticari-klima-kaset-tipi',
});

const products = [
    {
        "name": "Kaset Tipi Inverter Klima - 48000 BTU/h",
        "stock_code": "GUD140T1/A-S",
        "capacity": "48.000 BTU/h",
        "slug": "gree-ticari-klima-kaset-tipi-48000-btu"
    },
    {
        "name": "Kaset Tipi Inverter Klima - 42000 BTU/h",
        "stock_code": "GUD125T1A-S",
        "capacity": "42.000 BTU/h",
        "slug": "gree-ticari-klima-kaset-tipi-42000-btu"
    },
    {
        "name": "Kaset Tipi Inverter Klima - 36000 BTU/h",
        "stock_code": "GUD100T1/A-S",
        "capacity": "36.000 BTU/h",
        "slug": "gree-ticari-klima-kaset-tipi-36000-btu"
    },
    {
        "name": "Kaset Tipi Inverter Klima - 24000 BTU/h",
        "stock_code": "GUD71T1/A-S",
        "capacity": "24.000 BTU/h",
        "slug": "gree-ticari-klima-kaset-tipi-24000-btu"
    },
    {
        "name": "Kaset Tipi Inverter Klima - 18000 BTU/h",
        "stock_code": "GUD50T1/A1-S",
        "capacity": "18.000 BTU/h",
        "slug": "gree-ticari-klima-kaset-tipi-18000-btu"
    }
];
    ...
    return (
        <div className="bg-white">
            ...
            <section className="relative -mt-[84px] md:-mt-[92px] w-full h-[300px] md:h-[400px] overflow-hidden">
                <img src="/ticari-klimalar.jpg" alt="Kaset Tipi Ticari Klima" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-black/50 flex items-center">
                    <div className="max-w-[1400px] mx-auto px-6 w-full text-center md:text-left">
                        <h1 className="text-3xl md:text-6xl font-black text-white uppercase tracking-tighter">
                            Kaset Tipi <br/><span className="text-[#009be1]">Ticari Klima</span>
                        </h1>
                    </div>
                </div>
            </section>
