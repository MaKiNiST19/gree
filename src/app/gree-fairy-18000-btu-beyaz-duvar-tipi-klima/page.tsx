...
export const metadata = generateSEO({
    title: 'Gree Fairy 18000 BTU/h Beyaz Inverter Klima | İzmir Gree Klima',
    description: 'En uygun Gree Fairy 18000 BTU/h Beyaz Inverter Klima fiyatı (63.900,00 TL). Beyaz tasarım, R32 gaz, Wi-Fi kontrolü ve 6 yıl garanti ile İzmir yetkili bayisinde.',
    pathname: '/gree-fairy-18000-btu-beyaz-duvar-tipi-klima',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GWH18ACD-K6DNA1I-W" },
...
export default function Page() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'Fairy 18000 BTU/h - Beyaz', url: '/gree-fairy-18000-btu-beyaz-duvar-tipi-klima' }
    ]);

    return (
        <FairyProductLayout
            title="Gree Fairy 18000 BTU/h Beyaz Inverter Klima"
            ...
            btu="18000"
            price="63.900,00 TL"
            installment="5.964,00 TL'den başlayan taksitler"
            techSpecs={techSpecs}
            colorLabel="BEYAZ TASARIM"
            seoContent={<FairyDynamicSeoArticle modelCode="GWH18ACD-K6DNA1I-W" btu="18000" price="63.900,00 TL" installment="5.964,00 TL'den başlayan taksitler" color="Beyaz" />}
