...
const galleryImages = [
    "/img/products/multi-sistem/multi-duvar-tipi-pular-ic-unite-18000-btu-h-0.png",
    "/img/products/multi-sistem/multi-duvar-tipi-pular-ic-unite-18000-btu-h-1.png"
];
