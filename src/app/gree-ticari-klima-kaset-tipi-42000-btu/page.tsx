...
export const metadata = generateSEO({
    title: 'Gree Kaset Tipi Inverter Klima - 42000 BTU/h | İzmir Yetkili Bayi',
    description: 'GUD125T1A-S stok kodlu Gree Kaset Tipi Ticari Klima serisi ticari klima. 42.000 BTU/h kapasite, Inverter teknolojisi ve yüksek enerji verimliliği.',
    pathname: '/gree-ticari-klima-kaset-tipi-42000-btu',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GUD125T1A-S" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'Kaset Tipi Inverter Klima - 42000 BTU/h', url: '/gree-ticari-klima-kaset-tipi-42000-btu' }
    ]);

    return (
        <MultiProductLayout
            title="Gree Kaset Tipi Inverter Klima - 42000 BTU/h"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree Kaset Tipi Inverter Klima - 42000 BTU/h İle Profesyonel Çözümler</h3>
