...
export const metadata = generateSEO({
    title: 'Gree Multi Sistem Kaset Tek Yön İç Ünite 12000 BTU/h | İzmir Yetkili Bayi',
    description: 'GKH12DA-K6DNA1A/I stok kodlu Gree Kaset Tek Yön serisi multi sistem iç ünite. Estetik tasarım, sessiz çalışma ve yüksek konfor. İzmir Gree yetkili servis güvencesiyle.',
    pathname: '/gree-multi-ic-unite-kaset-tek-yon-12000-btu',
});

const techSpecs = [
    {
        "label": "Stok Kodu",
        "value": "GKH12DA-K6DNA1A/I"
    },
    {
        "label": "Kapasite",
        "value": "12.000 BTU/h"
...
export default function Page() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'Kaset Tek Yön 12000 BTU/h İç Ünite', url: '/gree-multi-ic-unite-kaset-tek-yon-12000-btu' }
    ]);

    return (
        <MultiProductLayout
            title="Gree Multi Sistem Kaset Tek Yön İç Ünite 12000 BTU/h"
            ...
            btu="12000"
            techSpecs={techSpecs}
            seoContent={<MultiDynamicSeoArticle modelCode="GKH12DA-K6DNA1A/I" btu="12000" />}
