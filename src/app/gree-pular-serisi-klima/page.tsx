...
import PularSeoArticle from '@/components/seo/PularSeoArticle';

export const metadata = generateSEO({
    title: 'Gree Pular Serisi Duvar Tipi Klimalar | İzmir Gree Klima',
    description: 'Kompakt tasarımı ve sessiz çalışma prensibiyle ev konforunun vazgeçilmez modern serisi. Dahili Wi-Fi özelliği sunar. İzmir yetkili bayii avantajları ve profesyonel kurulum hizmetiyle.',
    pathname: '/gree-pular-serisi-klima',
});
                ...
                <div className="max-w-[1400px] mx-auto px-6 relative z-10 w-full">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-lg md:text-xl text-white/90 mb-10 leading-relaxed font-medium drop-shadow-lg">
                            Kompakt tasarımı ve sessiz çalışma prensibiyle ev konforunun vazgeçilmez modern serisi. Dahili Wi-Fi özelliği sunar.
                        </p>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-[1400px] mx-auto px-6">
                    <div className="text-center mb-20">
                        <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-4">Pular Serisi Klima <span className="text-[#009be1]">Ürünleri</span></h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-10 gap-y-20 pt-8">
                        ...
                        <Link href="/gree-pular-9000-btu-duvar-tipi-klima" className="group relative block z-0">
                            {/* 3rd background card */}
                            <div className="absolute inset-0 rounded-[32px] border border-gray-200 bg-gray-50/50 transform translate-x-4 -translate-y-4 shadow-sm transition-all duration-500 ease-out group-hover:translate-x-6 group-hover:-translate-y-6 -z-20" />
                            
                            {/* 2nd background card */}
                            <div className="absolute inset-0 rounded-[32px] border border-gray-200 bg-gray-100/50 transform translate-x-2 -translate-y-2 shadow-sm transition-all duration-500 ease-out z-0 group-hover:translate-x-3 group-hover:-translate-y-3 -z-10" />
                            ...
                            <div className="relative z-10 bg-white border border-gray-100 rounded-[32px] overflow-hidden shadow-sm transition-all duration-500 group-hover:shadow-2xl flex flex-col h-full p-6 text-center">
                                <div className="relative w-full aspect-square mb-6 p-6 flex items-center justify-center bg-gray-50/50 rounded-2xl overflow-hidden">
                                    <img 
                                        src="/pular/galeri/pular-r.png" 
                                        alt="Pular 9000 BTU/h"
                                ...
                                <p className="text-xs text-gray-500 leading-relaxed font-medium mb-6 line-clamp-2">
                                    Kompakt ve akıllı iklimlendirme.
                                </p>
                        ...
                        <Link href="/gree-pular-12000-btu-duvar-tipi-klima" className="group relative block z-0">
                            {/* 3rd background card */}
                            <div className="absolute inset-0 rounded-[32px] border border-gray-200 bg-gray-50/50 transform translate-x-4 -translate-y-4 shadow-sm transition-all duration-500 ease-out group-hover:translate-x-6 group-hover:-translate-y-6 -z-20" />
                            ...
                            <div className="relative z-10 bg-white border border-gray-100 rounded-[32px] overflow-hidden shadow-sm transition-all duration-500 group-hover:shadow-2xl flex flex-col h-full p-6 text-center">
                                ...
                                <p className="text-xs text-gray-500 leading-relaxed font-medium mb-6 line-clamp-2">
                                    Sessiz çalışma ve yüksek enerji tasarrufu.
                                </p>
                        ...
                        <Link href="/gree-pular-18000-btu-duvar-tipi-klima" className="group relative block z-0">
                            {/* 3rd background card */}
                            <div className="absolute inset-0 rounded-[32px] border border-gray-200 bg-gray-50/50 transform translate-x-4 -translate-y-4 shadow-sm transition-all duration-500 ease-out group-hover:translate-x-6 group-hover:-translate-y-6 -z-20" />
                            ...
                            <div className="relative z-10 bg-white border border-gray-100 rounded-[32px] overflow-hidden shadow-sm transition-all duration-500 group-hover:shadow-2xl flex flex-col h-full p-6 text-center">
                                ...
                                <p className="text-xs text-gray-500 leading-relaxed font-medium mb-6 line-clamp-2">
                                    Güçlü fan hızı ve homojen dağılım.
                                </p>
                        ...
                        <Link href="/gree-pular-24000-btu-duvar-tipi-klima" className="group relative block z-0">
                            {/* 3rd background card */}
                            <div className="absolute inset-0 rounded-[32px] border border-gray-200 bg-gray-50/50 transform translate-x-4 -translate-y-4 shadow-sm transition-all duration-500 ease-out group-hover:translate-x-6 group-hover:-translate-y-6 -z-20" />
                            ...
                            <div className="relative z-10 bg-white border border-gray-100 rounded-[32px] overflow-hidden shadow-sm transition-all duration-500 group-hover:shadow-2xl flex flex-col h-full p-6 text-center">
                                ...
                                <p className="text-xs text-gray-500 leading-relaxed font-medium mb-6 line-clamp-2">
                                    Geniş alanlar için en sessiz dikey çözümler.
                                </p>
