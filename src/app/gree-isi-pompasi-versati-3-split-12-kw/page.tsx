...
export const metadata = generateSEO({
    title: 'Gree VERSATI-3 SPLİT TİP R32 60°C WİFİ – 12 kW | İzmir Yetkili Bayi',
    description: 'GRS-CQ12Pd/NhH-E stok kodlu Gree Versati III Split Tip Isı Pompası serisi ısı pompası. 12 kW kapasite, yüksek enerji tasarrufu ve çevreci R32 gaz.',
    pathname: '/gree-isi-pompasi-versati-3-split-12-kw',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GRS-CQ12Pd/NhH-E" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'VERSATI-3 SPLİT TİP R32 60°C WİFİ – 12 kW', url: '/gree-isi-pompasi-versati-3-split-12-kw' }
    ]);

    return (
        <MultiProductLayout
            title="Gree VERSATI-3 SPLİT TİP R32 60°C WİFİ – 12 kW"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree VERSATI-3 SPLİT TİP R32 60°C WİFİ – 12 kW İle Ekonomik İklimlendirme</h3>
