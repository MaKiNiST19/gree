...
export const metadata = generateSEO({
    title: 'Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 26 kW | İzmir Yetkili Bayi',
    description: 'GRS-CQ26PD/NHG3-E stok kodlu Gree Versati IV Monoblok Tip Isı Pompası serisi ısı pompası. 26 kW kapasite, yüksek enerji tasarrufu ve çevreci R32 gaz.',
    pathname: '/gree-isi-pompasi-versati-4-monoblok-26-kw',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GRS-CQ26PD/NHG3-E" },
    { label: "Kapasite", value: "26 kW" },
...
export default function ProductPage() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 26 kW', url: '/gree-isi-pompasi-versati-4-monoblok-26-kw' }
    ]);

    return (
        <MultiProductLayout
            title="Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 26 kW"
            ...
            seoContent={
                <article className="prose prose-lg max-w-none">
                    <h3>Gree VERSATI 4 MONOBLOK 60 °C R32 WİFİ – 26 kW İle Ekonomik İklimlendirme</h3>
            ...
            galleryImages={["/img/products/isi-pompasi/versati-4-monoblok-60-c-r32-wifi-26-kw-0.png", "/img/products/isi-pompasi/versati-4-monoblok-60-c-r32-wifi-26-kw-1.png"]}
            documents={[
