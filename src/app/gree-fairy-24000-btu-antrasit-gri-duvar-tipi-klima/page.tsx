...
export const metadata = generateSEO({
    title: 'Gree Fairy 24000 BTU/h Antrasit Gri Inverter Klima | İzmir Gree Klima',
    description: 'En uygun Gree Fairy 24000 BTU/h Antrasit Gri Inverter Klima fiyatı (82.300,00 TL). Antrasit Gri tasarım, R32 gaz, Wi-Fi kontrolü ve 6 yıl garanti ile İzmir yetkili bayisinde.',
    pathname: '/gree-fairy-24000-btu-antrasit-gri-duvar-tipi-klima',
});

const techSpecs = [
    { label: "Stok Kodu", value: "GWH24ACD-K6DNA1I-B" },
...
export default function Page() {
    const breadcrumb = generateBreadcrumbSchema([
        ...
        { name: 'Fairy 24000 BTU/h - Antrasit Gri', url: '/gree-fairy-24000-btu-antrasit-gri-duvar-tipi-klima' }
    ]);

    return (
        <FairyProductLayout
            title="Gree Fairy 24000 BTU/h Antrasit Gri Inverter Klima"
            ...
            btu="24000"
            price="82.300,00 TL"
            installment="7.681,33 TL'den başlayan taksitler"
            techSpecs={techSpecs}
            colorLabel="ANTRASİT GRİ TASARIM"
            seoContent={<FairyDynamicSeoArticle modelCode="GWH24ACD-K6DNA1I-B" btu="24000" price="82.300,00 TL" installment="7.681,33 TL'den başlayan taksitler" color="Antrasit Gri" />}
