...
import { 
    Wind, Zap, ShieldCheck, ArrowRight, Gauge, Truck, Star,
    FileText,
...
interface SalonProductLayoutProps {
    title: string;
    description: string;
    btu: string;
    price: string;
...
export default function SalonProductLayout({
    title,
    description,
    btu,
    price,
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="mb-10 inline-block">
                                <span className="block text-sm font-bold text-gray-400 uppercase tracking-widest mb-1">Peşin Fiyatı</span>
                                <div className="flex items-baseline gap-2">
                                    <span className="text-5xl font-black text-blue-900 tracking-tighter">{price}</span>
                                </div>
                                <div className="mt-3 text-[#f39000] font-bold flex items-center gap-2">
                                    <span className="w-2 h-2 rounded-full bg-[#f39000] animate-pulse" />
                                    {installment}
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-10">
                                ...
                                <Link href="https://wa.me/902322316583" className="fancy-button w-full bg-green-500 text-white font-semibold py-4 px-8 rounded-md shadow-lg flex items-center justify-center gap-3 transition-all">
                            ...
                            <div className="flex flex-wrap gap-6 border-t border-gray-200 pt-8">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-400">3 Yıl Yetkili Servis</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                                {[
                                    ...
                                    { label: "Kullanım Kılavuzu", icon: "/aphro/kilavuz-icon.png", link: "/salon/Coomer-Salon-Tipi-Kullanici-Kilavuzu_TR.pdf" },
            ...
            <section className="py-24 bg-[#fafafa]">
                 <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8 justify-center">
                         <img src="/salon/tanitim/salon_tipi_web.webp" alt="Salon Detay 1" className="w-full h-full object-cover rounded-[32px] shadow-sm hover:shadow-md transition-shadow" />
                    </div>
                 </div>
            </section>
...
fs.writeFileSync('e:/greeklima/greeklimaizmir/src/components/SalonProductLayout.tsx', layoutTemplate, 'utf8');
console.log('Salon layout created.');
